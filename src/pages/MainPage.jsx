...
function MainPage() {
  ...
  const isLoading =
    !mainData || (topSales.length + topToday.length + newItems.length) === 0
      ...
      <div className="main">
        ...
        <section id="best-products">
          <div className="section-title">
            ...
            <Link className="more-btn" to="/search?sort=topToday">
              ...
              return (
                <div key={id} className="card">
                  <Link to={`/items/detail/${id}`}>
                    <img height="160" src={buildImg(item.itemImgUrl)} alt={item.itemNm} />
        ...
        <section id="rainy-dog">
          <div className="section-title">
            <p>
              ...
              <iconify-icon
                style={{ marginLeft: '10px' }}
                icon="streamline-pixel:weather-umbrella-snowing"
                width="32"
                height="32"
              />
            </p>
            <Link className="more-btn" to="/search?tag=rainy-dog">
              More <iconify-icon icon="pixel:angle-right" width="13" height="13" />
            </Link>
          </div>
        ...
        <section id="ss-new">
          <div className="section-title">
            ...
            <Link className="more-btn" to="/search?sort=newItems">
              More <iconify-icon icon="pixel:angle-right" width="13" height="13" />
            </Link>
          </div>
