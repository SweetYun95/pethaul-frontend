...
const PetEditPage = () => {
  ...
  const currentImg =
    initial?.images?.[0]?.imgUrl
      ? (initial.images[0].imgUrl.startsWith('/images/')
          ? initial.images[0].imgUrl
          : `${baseUrl}${initial.images[0].imgUrl}`)
      : '/images/no-image.jpg'

  const previewUrl = useMemo(
    () => (file ? URL.createObjectURL(file) : currentImg),
    [file, currentImg]
  )
          ...
          <div className="alert-success">
            ...
            <div className="preview-card">
              ...
              <div>
                ...
                <button className="btn" onClick={() => setSuccessPet(null)}>다시 수정하기</button>
              </div>
            </div>
          </div>
        )}
